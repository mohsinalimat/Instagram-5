...
class HomePostCell: UICollectionViewCell {
  ...
  private func setupCaption() {
    ...
    attributedText.append(NSAttributedString(string: timeAgo, attributes: [NSFontAttributeName: UIFont.systemFont(ofSize: 14), NSForegroundColorAttributeName: UIColor.gray]))
